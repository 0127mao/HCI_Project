<template>
  <div class="body_login">
    <h1 class="ml1_login">
      <span class="text-wrapper_login">
        <span class="line_login line1_login"></span>
        <span class="letters_login">Book && Book</span>
        <span class="line_login line2_login"></span>
      </span>
    </h1>
    <div
      class="container"
      ...
      <div class="container__form container--signup">
        <form @submit="submitForm_register" action="#" class="form" id="form1">
          ...
          <input
            ...
            type="text"
            placeholder="用户名"
            v-model="ruleform_register.uname"
            class="input"
          />
          <input
            id="pass"
            type="password"
            v-model="ruleform_register.pass"
            placeholder="密码"
            class="input"
          />
          <input
            id="password"
            type="password"
            v-model="ruleform_register.password"
            placeholder="确认密码"
            class="input"
          />
          <button class="btn" type="submit" :disabled="loading_register">
            Sign Up
          </button>
          <button
            class="btn"
            type="button"
            @click="resetForm('ruleform_register')"
          >
            reset
          </button>
        </form>
      ...
      <div class="container__form container--signin">
        <form action="#" class="form" id="form2">
          ...
          <button
            class="btn"
            type="button"
            @click="resetForm_login('ruleForm')"
          >
            reset
          </button>
        </form>
...
export default {
  mounted() {
    var textWrapper = document.querySelector(".ml1_login .letters_login");
    textWrapper.innerHTML = textWrapper.textContent.replace(
      /\S/g,
      "<span class='letter_login'>$&</span>"
    );

    anime
      .timeline({ loop: true })
      .add({
        targets: ".ml1_login .letter_login",
        scale: [0.3, 1],
        opacity: [0, 1],
        translateZ: 0,
        easing: "easeOutExpo",
...
.ml1_login .letter_login {
  display: inline-block;
  line-height: 1em;
}
.ml1_login .text-wrapper_login {
  position: relative;
  display: inline-block;
  padding-top: 0.1em;
...
.ml1_login .line1_login {
  top: 0;
}
.ml1_login .line2_login {
  bottom: 0;
}
/* 样式代码 */
:root {
